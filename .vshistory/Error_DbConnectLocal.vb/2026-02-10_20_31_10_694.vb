    ...
    Private Shared ReadOnly Property user_condrop() As String
        Get
            If String.IsNullOrEmpty(_user_condrop) Then
                Dim encryptedValue As String = Error_Helper.RegistryReadValue(Error_Helper.RegistryHiveValue, Error_Helper.RegistryPath & "\Database\" & Error_DbConnectLocal.DBRegFolder_ConDrop, "db_User")
                Error_cCrypt.Decrypt(256, Error_VarConvert.ConvertToString(encryptedValue))
