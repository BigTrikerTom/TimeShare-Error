...
Public Class Error_CheckConnect
#Region "Properties"
...
#Region "Perform Cecks"
    Public Shared Sub DoCheck()
        ...
        Loop
        Dim CheckRes As New Error_CheckConnect.CheckResults
    ...
    Private Shared Sub DoCheckRegistry()
        ...
        'Dim LocalRegistryPath As String = "SOFTWARE\TimeShareIT"
        If CheckRegistry Then
            Dim rb As Boolean = Error_Helper.RegistryWriteValue(Error_Helper.RegistryHiveValue, Error_Helper.RegistryPath, "Test", jetzt)
            Dim jetztread As String = Error_VarConvert.ConvertToString(Error_Helper.RegistryReadValue(Error_Helper.RegistryHiveValue, Error_Helper.RegistryPath, "Test"))
            If jetzt <> jetztread OrElse Not rb Then
                ...
                cr.RegResult = False
            Else
                Call Error_Helper.RegistryDeleteKey(Error_Helper.RegistryHiveValue, Error_Helper.RegistryPath, "Test")
                cr.RegMessage = "OK"
...
#Region "CheckRegistry"
    ...
    '            If clsError_Helper.KeyExist(Hive, RegPath) = False Then
    ...
    '    Return True
    'End Function
    'Public Shared Function RegistryReadValue(Hive As RegistryHive, RegPath As String, Key As String, Optional VariType As clsError_Helper.VarTypeEnum = clsError_Helper.VarTypeEnum.Type_String) As Object
    '    Dim regKey As RegistryKey = Nothing
    ...
    '            Case clsError_Helper.VarTypeEnum.Type_Boolean
    '                Return False
    '            Case clsError_Helper.VarTypeEnum.Type_Double
    '                Return 0
    '            Case clsError_Helper.VarTypeEnum.Type_Integer
    '                Return 0
    '            Case clsError_Helper.VarTypeEnum.Type_String
    '                Return ""
    '            Case clsError_Helper.VarTypeEnum.Type_DateAsString
    '                Return ""
    '            Case clsError_Helper.VarTypeEnum.Type_Date
    ...
    '    Select Case Hive
    '        Case RegistryHive.ClassesRoot
    '            If clsError_Helper.KeyExist(Hive, RegPath) Then
...
#Region "CheckDb"
    ...
    Private Shared Function TestDbConnection(user As String, pass As String, host As String, db As String) As DBTestResult
        ...
        Try
            ...
            Using con_test As New MySqlConnection
                ...
                cmd_test.CommandTimeout = Error_DbConnectLocal.CmdTimeout
                ...
                Try
                    ...
                    If cmd_test.Connection.State = ConnectionState.Open Then
                        ...
                        Call Error_Logger.writelog(Level.Info, "Test-DbConnection wurde erfolgreich hergestellt.")
                        con_test.Close()
                        con_test.Dispose()
                    Else
                        RetMess.Result = False
                        MainFormInfo.Text = "Die Datenbankverbindung konnte nicht hergestellt werden."
                        Call Error_Logger.writelog(Level.Info, "Test-DbConnection konnte nicht hergestellt werden. Connection String: " & con_test.ConnectionString)
                ...
                Catch ex As Exception
                    ...
                    Call Error_Logger.writelog(Level.Info, "Test-DbConnection ist fehlgeschlagen. Connection String: " & con_test.ConnectionString)
                    RetMess.Result = False
        ...
        Catch ex As Exception
            'Call clsError.HandleErrorCatch(ex, clsError_Helper.GetCallingProc(), System.Reflection.MethodBase.GetCurrentMethod().Name, Environment.CurrentManagedThreadId,  False, False)
...
#Region "HelperFunctions"
    ...
    '    Next
    'End Sub
    'Public Shared Function Checkvar(ByVal var As Object, ByVal VariType As clsError_Helper.VarTypeEnum, Optional ByVal trimed As Boolean = False, Optional ByVal DefaultValue As Object = Nothing) As Object
    ...
    '    Try
    '        If VariType = clsError_Helper.VarTypeEnum.Type_Boolean Then
    '            Return modExtensions.ToBoolean(var)
    '        ElseIf VariType = clsError_Helper.VarTypeEnum.Type_Double Then
    '            Return modExtensions.ToDouble(var)
    '        ElseIf VariType = clsError_Helper.VarTypeEnum.Type_Integer Then
    '            Return modExtensions.ToInteger(var)
    '        ElseIf VariType = clsError_Helper.VarTypeEnum.Type_Long Then
    '            Return modExtensions.ToLong(var)
    '        ElseIf VariType = clsError_Helper.VarTypeEnum.Type_Single Then
    '            Return modExtensions.ToSingle(var)
    '        ElseIf VariType = clsError_Helper.VarTypeEnum.Type_String Then
    ...
    '        ElseIf VariType = clsError_Helper.VarTypeEnum.Type_Date Then
    '            If var Is Nothing OrElse Convert.IsDBNull(var) OrElse String.IsNullOrWhiteSpace(var.ToString) Then
    ...
    '        ElseIf VariType = clsError_Helper.VarTypeEnum.Type_DateAsString Then
    '            If var Is Nothing OrElse Convert.IsDBNull(var) OrElse String.IsNullOrWhiteSpace(var.ToString) Then
    ...
    '    Catch ex As Exception
    '        Call clsError.HandleErrorCatch(ex, clsError_Helper.GetCallingProc(), System.Reflection.MethodBase.GetCurrentMethod().Name, Environment.CurrentManagedThreadId,  False, False)
    '        If clsError_Helper.IsIDE() Then Stop
    '        Return ""
    '    End Try
    'End Function
